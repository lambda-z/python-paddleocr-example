...
def main():
    ...
    """
        ...
        手写识别:
        图片坐标:  [[105.0, 204.0], [444.0, 204.0], [444.0, 298.0], [105.0, 298.0]]
        文字:  手写测试 置信度:  79.5647 %
        --------------
        [[[105.0, 372.0], [1511.0, 304.0], [1516.0, 410.0], [110.0, 478.0]], ('文字测闭：大小中晶美水之', 0.9321432113647461)]
        图片坐标:  [[105.0, 372.0], [1511.0, 304.0], [1516.0, 410.0], [110.0, 478.0]]
        文字:  文字测闭：大小中晶美水之 置信度:  93.2143 %
    """
